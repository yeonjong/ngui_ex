public class ChapterMapState : GameStateBase {

	public override void OnEnter(GAME_STATE prev_gs) {
		base.OnEnter(prev_gs);

		GuiMgr.GetInst ().PushPanel (PANEL_TYPE.ChapterMap);
		//GuiMgr.GetInst().ShowChapterMapUI();
	}
	...
	public override void OnLeave(GAME_STATE next_gs) {
		...
		//GuiMgr.GetInst().HideChapterMapUI();
	}
