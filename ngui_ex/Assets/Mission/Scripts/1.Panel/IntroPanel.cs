...
public class IntroPanel : MonoBehaviour {
	...
	private void Awake() {
		id = "jipsa123";
		pw = "password";
		transform.FindChild("sub_pnl_login/input_field_id/Label").GetComponent<UILabel>().text = id;
		transform.FindChild("sub_pnl_login/input_field_pw/Label").GetComponent<UILabel>().text = pw;
	}
	#endif
